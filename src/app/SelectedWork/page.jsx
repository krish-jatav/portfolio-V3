...
export default function SelectedWork() {
  return (
    <div className="bg-[#DDDDD8]">
      ...
      <div  className="  flex  justify-center gap-10 px-10 flex-wrap lg:flex-nowrap">
  <div className="h-[35rem]  shadow-2xl  w-[25rem] rounded-3xl overflow-hidden  hover:w-[35rem] lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">
  ...
  <div className="h-[35rem] shadow-2xl overflow-hidden w-[25rem] shadow-black-10  rounded-3xl hover:w-[35rem] lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">
  ...
  <div className="h-[35rem] shadow-2xl overflow-hidden w-[25rem]  rounded-3xl hover:w-[35rem] lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">

...
export default function SelectedWork() {
  ...
  <div className="h-[30rem]  w-[25rem] rounded-3xl overflow-hidden  hover:w-[35rem] lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">
  ...
  <div className="h-[30rem] overflow-hidden w-[25rem]  rounded-3xl hover:w-[35rem] lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">

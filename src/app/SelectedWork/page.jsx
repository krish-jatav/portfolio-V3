...
export default function SelectedWork() {
  ...
  <div className="h-[35rem] w-full   shadow-2xl  lg:w-[30rem] rounded-3xl overflow-hidden   lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">
  ...
  <div className="box h-[35rem] w-full lg:w-[30rem]   shadow-2xl overflow-hidden  shadow-black-10  rounded-3xl  lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">
  ...
  <div className="box h-[35rem] w-full  lg:w-[30rem]   shadow-2xl overflow-hidden   rounded-3xl lg:hover:w-[35rem] transition-all duration-1000 ease-in-out">

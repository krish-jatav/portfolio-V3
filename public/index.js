...
export { default as redBull } from "./redBulll.png";
export { default as creativeDev } from "./creativeDev.png";
export { default as Uiux } from "./UIUX-webflow.png";
export { default as chairlable } from "./chairable.png";
export { default as theArt } from "./ArtCentury.png";
export { default as genAi } from "./genAi.png";
export { default as ranching } from "./ranching.png";
export { default as myImage } from "./profileIMG.jpg";
